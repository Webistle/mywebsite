...
*/
update_option('gt3_supported_account_notice_srart','false');
update_option('gt3_registration','weadown');
update_option('gt3_supported_account_registration_srart','false');
update_option('gt3_supported_notice_srart','true');
update_option('gt3_registration_supported_until','01.01.2030');
update_option('gt3_tmeme_id','100' );
...
update_option('gt3_tmeme_id' , '100' );
update_option('gt3_registration_id','100');
